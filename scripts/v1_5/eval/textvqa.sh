...
CUDA_VISIBLE_DEVICES=0 python -m llava.eval.model_vqa_loader \
    ...
    --answers-file ./playground/data/eval/textvqa/answers/llava-visualprism-7b.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1

CUDA_VISIBLE_DEVICES=0 python -m llava.eval.eval_textvqa \
    --annotation-file ./playground/data/eval/textvqa/TextVQA_0.5.1_val.json \
    --result-file ./playground/data/eval/textvqa/answers/llava-visualprism-7b.jsonl
